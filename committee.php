...
?>
  ...
  font-weight: 800;"> ICTMI Conference </h2> </a>
                </div>
                <!--Right Container-->
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown"><a href="schedule.php">Schedule</a> </li>
                                <li class="dropdown"><a href="speakers.php">Speakers</a> </li>
                                <li class="current dropdown"><a href="#">Committee</a> </li>
                                <li class="dropdown"><a href="guidelines.php">Full Paper Submission</a> </li>
                                <li class="dropdown"><a href="sponsorship.php">Sponsorship</a> </li>
                            </ul>
    ...
    <section class="services-area">
        <div class="auto-container" style="padding-top:50px;">
            <div class="sec-title wow fadeInLeft animated" data-wow-delay="0ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeInLeft;">
                <h2 style="font-size:22px;">Organizing <span>Committee</span></h2> </div><br><br>
            <h3 class="payment">Chief Patron</h3><br><br>
            ...
            <!--  
                ...
                -->
            <br><br><h3 class="payment">Patrons</h3><br><br>
            <div class="row clearfix">
            ...
            <!--   <article class="col-md-4 col-sm-6 col-xs-12 post wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                ...
                -->
            <br><br><h3 class="payment">General Chair</h3><br><br>
            <div class="row clearfix">
                <article class="col-md-12 col-sm-12 col-xs-12 post wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><h3 class="payment">Organizing Chair</h3><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-6 col-xs-12 post wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><div class="payment">Associate Chair</div><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-12 col-xs-12 post wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><div class="payment">Organizing Secretary</div><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-12 col-xs-12 post wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><div class="payment">Programme Chair</div><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-12 col-xs-12 post wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><div class="payment">Technical Chair</div><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-6 col-xs-12 post wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><div class="payment">Executive Member</div><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-6 col-xs-12 post wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                    <div class="post-inner">
            ...
            <br><br><div class="payment">International Organizing Member</div><br><br>
            <div class="row clearfix">
                <article class="col-md-4 col-sm-6 col-xs-12 post wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
                    <div class="post-inner">
