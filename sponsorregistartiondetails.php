...
include 'top.php';
	...
	$sql="SELECT * FROM sponsors WHERE id='$userid'";
...
<!-- Header Lower -->
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">                                                                                              
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="current dropdown"><a href="sponsorship.php">Sponsorship</a>
 ...
 <div align="center">
  ...
  <div  align="right"><a href="sponsorlogout.php" ><b>Logout</b></a></div>
    ...
    <table width="50%" border="0" align="center" class="table">
        <tbody>
        	 <tr>
                <td valign="middle" align="" class="tablecontent1">Company Name</td>
			  ...
			  <tr>
				<td valign="middle" align="" class="tablecontent1">Company Address </td>
				<td valign="middle" align="left" class="tablecontent1">
			   ...
			   <tr>
				<td valign="middle" align="" class="tablecontent1">Citizen </td>
				<td valign="middle" align="left" class="tablecontent1">
