    ...
    <section class="services-area" >
    	<div class="auto-container" style="padding-top:50px;">
            ...
            <div class="sec-title wow fadeInLeft animated" data-wow-delay="0ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 300ms; animation-name: fadeInLeft;">
                <h2 style="font-size:22px;">Congratulations </h2>
                <p>
             ...
             <h3 class="payment" style="line-height:28px;">
               Your conference sponsorship registration has been successful.
               A confirmation email containing your Registration ID has been sent to the email address provided during registration.
If you didn't get it, please check your spam box.
<br/>
<br/>
<font color="red">Please note that your place can only be confirmed once we have received your sponsporship fee.</font>
<br/>
Click here to take the <a style="text-decoration:none;" href="sponsorlogin.php">printout</a> of registration form. </h3>
